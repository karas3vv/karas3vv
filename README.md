...
[![SQL](https://img.shields.io/badge/SQL-3776AB?style=for-the-badge&logo=postgresql&logoColor=white)](https://www.postgresql.org/)
...
Currently exploring:
- LLMs;
- NLP applications (sentiment analysis, text summarization, etc.);
